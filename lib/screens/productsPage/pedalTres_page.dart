...
class PedalTresPage extends StatefulWidget {
  const PedalTresPage({super.key});

  @override
  State<PedalTresPage> createState() => _PedalTresPageState();
}

class _PedalTresPageState extends State<PedalTresPage> {
  @override
